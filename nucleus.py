...
#http://34.83.118.232:4460/edit/nucleus.py# a variety of images to surve as a validation set.
VAL_IMAGE_IDS = [
...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        for image_id in image_ids:
            self.add_image(
                "nucleus",
                image_id=image_id,
                path=os.path.join(dataset_dir, image_id, "images/{}.png".format("mask")))
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        return mask[:,:,0,:], np.ones([mask.shape[-1]], dtype=np.int32)
